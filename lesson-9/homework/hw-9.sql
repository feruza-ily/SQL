...
-- 6
select p.ProductName, o.* from orders o
join products p
on o.ProductID = p.ProductID

-- 7
select e.name, d.* from departments d
...
-- 20
select o.*, c.country, o.totalamount
from orders o
join customers c
...
select e.name Employee, e.salary Salary, m.name Manager, m.Salary Salary
from employees m
join employees e
...
-- 25
select c.customerid, c.firstname, c.lastname from orders o
left join customers c
on o.CustomerID = c.CustomerID
