...
-- 1. Top 5 employees from Employees table
SELECT TOP (5) *
FROM Employees;
...
-- 2. COALESCE for first non-NULL FirstName or LastName
SELECT EmployeeID,
...
-- 4. Employees with Age between 30-40 OR Department = 'Marketing'
SELECT *
FROM Employees
WHERE (Age BETWEEN 30 AND 40)
   OR Department = 'Marketing';

-- 5. Rows 11 to 20 from Employees ordered by Salary DESC
SELECT *
FROM Employees
...
-- 7. Products whose ProductName contains 'e'
SELECT *
FROM Products
...
-- 3. DISTINCT Category, ProductName, Price where Price > 50
...
-- 7. Employees with salary greater than all in Sales
SELECT *
FROM Employees
WHERE Salary > ALL (
    SELECT Salary
